...
# instance fields
.field a:Landroid/support/v7/widget/v;
...
.method private h()Landroid/view/Menu;
    ...
    iget-object v0, p0, Landroid/support/v7/app/f;->a:Landroid/support/v7/widget/v;

    new-instance v1, Landroid/support/v7/app/f$a;

    invoke-direct {v1, p0}, Landroid/support/v7/app/f$a;-><init>(Landroid/support/v7/app/f;)V

    new-instance v2, Landroid/support/v7/app/f$b;

    invoke-direct {v2, p0}, Landroid/support/v7/app/f$b;-><init>(Landroid/support/v7/app/f;)V

    invoke-interface {v0, v1, v2}, Landroid/support/v7/widget/v;->a(Landroid/support/v7/view/menu/o$a;Landroid/support/v7/view/menu/h$a;)V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/v;->q()Landroid/view/Menu;
...
.method public a(ILandroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0}, Landroid/support/v7/app/f;->h()Landroid/view/Menu;
...
.method public a(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0}, Landroid/support/v7/app/f;->c()Z
...
.method public e(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, Landroid/support/v7/app/f;->d:Z
    ...
    iget-object v2, p0, Landroid/support/v7/app/f;->e:Ljava/util/ArrayList;
...
.method public e()Z
    ...
    iget-object v1, p0, Landroid/support/v7/app/f;->f:Ljava/lang/Runnable;
