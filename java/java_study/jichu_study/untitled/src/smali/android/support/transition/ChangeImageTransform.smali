...
.method public a(Landroid/view/ViewGroup;Landroid/support/transition/w;Landroid/support/transition/w;)Landroid/animation/Animator;
    ...
    invoke-static {p1}, Landroid/support/transition/i;->a(Landroid/widget/ImageView;)V
    ...
    sget-object p2, Landroid/support/transition/j;->a:Landroid/graphics/Matrix;

    :cond_7
    if-nez v2, :cond_8

    sget-object v2, Landroid/support/transition/j;->a:Landroid/graphics/Matrix;
    ...
    :goto_2
    invoke-static {p1, p2}, Landroid/support/transition/i;->a(Landroid/widget/ImageView;Landroid/animation/Animator;)V
...
.method public a(Landroid/support/transition/w;)V
    ...
    invoke-direct {p0, p1}, Landroid/support/transition/ChangeImageTransform;->d(Landroid/support/transition/w;)V
