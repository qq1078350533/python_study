...
.method private c(II)V
    ...
    iput-boolean v13, v9, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->f:Z

    iput v13, v9, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->c:I

    iput v13, v9, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->b:I

    iput-boolean v13, v9, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->d:Z
    ...
    :goto_2
    iput-boolean v3, v9, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->e:Z

    iget-boolean v3, v9, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->a:Z
    ...
    iget-boolean v15, v9, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->d:Z
    ...
    :cond_5
    iget-boolean v9, v9, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->a:Z
    ...
    iget-boolean v10, v7, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->d:Z
    ...
    :cond_a
    iget v10, v7, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->b:I

    if-ge v10, v3, :cond_b

    iget v3, v7, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->b:I
    ...
    iget v9, v10, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->b:I
    ...
    iget-boolean v1, v10, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->e:Z
    ...
    :goto_b
    iget v1, v10, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->b:I

    const/4 v2, 0x1

    add-int/2addr v1, v2

    iput v1, v10, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->b:I

    iput-boolean v2, v10, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->f:Z
    ...
    iput v9, v3, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->c:I

    const/4 v2, 0x1

    iput-boolean v2, v3, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->f:Z

    if-nez v1, :cond_1d

    iget-boolean v2, v3, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->e:Z
    ...
    iget-boolean v2, v3, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->a:Z
    ...
    iget-boolean v5, v3, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->f:Z
    ...
    :cond_24
    iget v5, v3, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->b:I
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/view/menu/h;->a(Z)V
