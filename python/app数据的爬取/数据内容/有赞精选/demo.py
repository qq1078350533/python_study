...
def test():
    ...
    parms = f"v=1.0&method=weapp.spotlight.search.rec.goodsarticle.list&size=10&sign_method=md5&key=美食&app_id=c9be2b0e1aeb5d0433&timestamp={timeslep}&sort_by=composite&page=1&format=json"
