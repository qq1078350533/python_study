...
// token是返回的， slide是坐标轨迹，x是坐标
function getslidevalue(token,slide,x) {
 var traceData = [];
 for (i = 0; i < slide.length;i++) {
  f = aaaa(token, slide[i] + "");
  traceData.push(f)
 }
 r = eypt(aaaa(token, x / 310 * 100 + ""))
 // return traceData
 return  JSON.stringify({
  d: eypt(traceData.join(":")),
  m: "",
  p: r,
  ext: eypt(aaaa(token, 1 + "," + traceData.length))
 })
}
console.log(getslidevalue('2a7f9c692cdb4c2394ef650363f7fa2e',[[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223],[4, 0, 223]],'156'))