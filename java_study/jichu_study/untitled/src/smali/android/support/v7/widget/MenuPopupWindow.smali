...
# instance fields
.field private b:Landroid/support/v7/widget/ae;
...
.method a(Landroid/content/Context;Z)Landroid/support/v7/widget/y;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->setHoverListener(Landroid/support/v7/widget/ae;)V
...
.method public a(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/MenuPopupWindow;->b:Landroid/support/v7/widget/ae;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2}, Landroid/support/v7/widget/ae;->a(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
...
.method public a(Landroid/support/v7/widget/ae;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/MenuPopupWindow;->b:Landroid/support/v7/widget/ae;
...
.method public b(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/widget/ae;->b(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
