...
.method private a(Landroid/support/v7/widget/RecyclerView$v;IIJ)Z
    ...
    invoke-virtual {p4, p1, p2}, Landroid/support/v7/widget/RecyclerView$a;->bindViewHolder(Landroid/support/v7/widget/RecyclerView$v;I)V
    ...
    invoke-virtual {p2, v0, p4, p5}, Landroid/support/v7/widget/RecyclerView$n;->b(IJ)V
...
.method private e(Landroid/support/v7/widget/RecyclerView$v;)V
    ...
    invoke-virtual {p1, v1}, Landroid/support/v7/widget/RecyclerView$v;->addFlags(I)V
...
.method a(IZJ)Landroid/support/v7/widget/RecyclerView$v;
    ...
    invoke-virtual {v1, v5}, Landroid/support/v7/widget/RecyclerView$v;->addFlags(I)V
    ...
    iget-object v9, v1, Landroid/support/v7/widget/RecyclerView$v;->itemView:Landroid/view/View;
    ...
    iput v5, v1, Landroid/support/v7/widget/RecyclerView$v;->mPosition:I
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$v;->resetInternal()V
    ...
    invoke-virtual {v2, v5, v9}, Landroid/support/v7/widget/RecyclerView$a;->createViewHolder(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$v;
    ...
    iget-object v5, v2, Landroid/support/v7/widget/RecyclerView$v;->itemView:Landroid/view/View;
    ...
    iput-object v10, v2, Landroid/support/v7/widget/RecyclerView$v;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {v5, v9, v10, v11}, Landroid/support/v7/widget/RecyclerView$n;->a(IJ)V
    ...
    invoke-virtual {v10, v0}, Landroid/support/v7/widget/RecyclerView$v;->hasAnyOfTheFlags(I)Z

    move-result v1

    if-eqz v1, :cond_10

    invoke-virtual {v10, v8, v0}, Landroid/support/v7/widget/RecyclerView$v;->setFlags(II)V
    ...
    invoke-virtual {v10}, Landroid/support/v7/widget/RecyclerView$v;->getUnmodifiedPayloads()Ljava/util/List;
    ...
    invoke-virtual {v10}, Landroid/support/v7/widget/RecyclerView$v;->isBound()Z

    move-result v0

    if-eqz v0, :cond_11

    iput v3, v10, Landroid/support/v7/widget/RecyclerView$v;->mPreLayoutPosition:I
    ...
    invoke-virtual {v10}, Landroid/support/v7/widget/RecyclerView$v;->needsUpdate()Z

    move-result v0

    if-nez v0, :cond_13

    invoke-virtual {v10}, Landroid/support/v7/widget/RecyclerView$v;->isInvalid()Z
    ...
    :goto_7
    iget-object v1, v10, Landroid/support/v7/widget/RecyclerView$v;->itemView:Landroid/view/View;
    ...
    iget-object v2, v10, Landroid/support/v7/widget/RecyclerView$v;->itemView:Landroid/view/View;
...
.method a(JIZ)Landroid/support/v7/widget/RecyclerView$v;
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$v;->getItemViewType()I
    ...
    invoke-virtual {v1, p1}, Landroid/support/v7/widget/RecyclerView$v;->addFlags(I)V
    ...
    invoke-virtual {v1, p1, p2}, Landroid/support/v7/widget/RecyclerView$v;->setFlags(II)V
...
.method a(II)V
    ...
    iget v7, v6, Landroid/support/v7/widget/RecyclerView$v;->mPosition:I
    ...
    invoke-virtual {v6, v7, v4}, Landroid/support/v7/widget/RecyclerView$v;->offsetPosition(IZ)V

    goto :goto_2

    :cond_2
    invoke-virtual {v6, v2, v4}, Landroid/support/v7/widget/RecyclerView$v;->offsetPosition(IZ)V
...
.method a(IIZ)V
    ...
    invoke-virtual {v2, v3, p3}, Landroid/support/v7/widget/RecyclerView$v;->offsetPosition(IZ)V
...
.method a(Landroid/support/v7/widget/RecyclerView$v;Z)V
    ...
    invoke-virtual {p1, v1, v0}, Landroid/support/v7/widget/RecyclerView$v;->setFlags(II)V
...
.method a(Landroid/support/v7/widget/RecyclerView$v;)Z
    ...
    iget p1, p1, Landroid/support/v7/widget/RecyclerView$v;->mPosition:I
...
.method b(IZ)Landroid/support/v7/widget/RecyclerView$v;
    ...
    invoke-virtual {v3}, Landroid/support/v7/widget/RecyclerView$v;->wasReturnedFromScrap()Z
    ...
    invoke-virtual {v3, p1}, Landroid/support/v7/widget/RecyclerView$v;->addFlags(I)V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/t;
    ...
    iget-object p2, p2, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/t;

    invoke-virtual {p2, v0}, Landroid/support/v7/widget/t;->e(Landroid/view/View;)V

    iget-object p2, p0, Landroid/support/v7/widget/RecyclerView$o;->f:Landroid/support/v7/widget/RecyclerView;

    iget-object p2, p2, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/t;

    invoke-virtual {p2, v0}, Landroid/support/v7/widget/t;->b(Landroid/view/View;)I
    ...
    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/t;

    invoke-virtual {v1, p2}, Landroid/support/v7/widget/t;->e(I)V

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/RecyclerView$o;->c(Landroid/view/View;)V

    const/16 p2, 0x2020

    invoke-virtual {p1, p2}, Landroid/support/v7/widget/RecyclerView$v;->addFlags(I)V
...
.method b(II)V
    ...
    invoke-virtual {v2, p2, v3}, Landroid/support/v7/widget/RecyclerView$v;->offsetPosition(IZ)V
...
.method b(Landroid/support/v7/widget/RecyclerView$v;)V
    ...
    invoke-virtual {p1}, Landroid/support/v7/widget/RecyclerView$v;->doesTransientStatePreventRecycling()Z
    ...
    invoke-virtual {v3, p1}, Landroid/support/v7/widget/RecyclerView$a;->onFailedToRecycleView(Landroid/support/v7/widget/RecyclerView$v;)Z
    ...
    invoke-virtual {p1, v3}, Landroid/support/v7/widget/RecyclerView$v;->hasAnyOfTheFlags(I)Z
    ...
    iget v4, v4, Landroid/support/v7/widget/RecyclerView$v;->mPosition:I

    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView$o;->f:Landroid/support/v7/widget/RecyclerView;

    iget-object v5, v5, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/ac$a;
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->h:Landroid/support/v7/widget/bb;

    invoke-virtual {v2, p1}, Landroid/support/v7/widget/bb;->g(Landroid/support/v7/widget/RecyclerView$v;)V
...
.method b(Landroid/view/View;)V
    ...
    iput-object v0, p1, Landroid/support/v7/widget/RecyclerView$v;->mScrapContainer:Landroid/support/v7/widget/RecyclerView$o;

    const/4 v0, 0x0

    iput-boolean v0, p1, Landroid/support/v7/widget/RecyclerView$v;->mInChangeScrap:Z
...
.method c(II)V
    ...
    :cond_0
    iget v2, v1, Landroid/support/v7/widget/RecyclerView$v;->mPosition:I
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/RecyclerView$v;->addFlags(I)V
...
.method c(Landroid/support/v7/widget/RecyclerView$v;)V
    ...
    iget-boolean v0, p1, Landroid/support/v7/widget/RecyclerView$v;->mInChangeScrap:Z
...
.method c(Landroid/view/View;)V
    ...
    invoke-virtual {p1, p0, v0}, Landroid/support/v7/widget/RecyclerView$v;->setScrapContainer(Landroid/support/v7/widget/RecyclerView$o;Z)V
...
.method d()V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/ac$a;
...
.method d(Landroid/support/v7/widget/RecyclerView$v;)V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->h:Landroid/support/v7/widget/bb;

    invoke-virtual {v0, p1}, Landroid/support/v7/widget/bb;->g(Landroid/support/v7/widget/RecyclerView$v;)V
...
.method f(I)Landroid/support/v7/widget/RecyclerView$v;
    ...
    invoke-virtual {v5}, Landroid/support/v7/widget/RecyclerView$v;->wasReturnedFromScrap()Z
    ...
    invoke-virtual {v5, v4}, Landroid/support/v7/widget/RecyclerView$v;->addFlags(I)V
    ...
    invoke-virtual {p1}, Landroid/support/v7/widget/RecyclerView$v;->wasReturnedFromScrap()Z
    ...
    invoke-virtual {p1, v4}, Landroid/support/v7/widget/RecyclerView$v;->addFlags(I)V
...
.method h()V
    ...
    invoke-virtual {v2, v3}, Landroid/support/v7/widget/RecyclerView$v;->addChangePayload(Ljava/lang/Object;)V
...
.method i()V
    ...
    invoke-virtual {v3}, Landroid/support/v7/widget/RecyclerView$v;->clearOldPosition()V
