...
.field i:Landroid/support/v4/e/n;
...
.field private j:Landroid/arch/lifecycle/n;
...
.method private static a(Landroid/support/v4/app/h;Landroid/arch/lifecycle/Lifecycle$State;)Z
    .locals 4
    ...
    iget-object v0, v1, Landroid/support/v4/app/Fragment;->ac:Landroid/arch/lifecycle/e;
    ...
    invoke-static {v1, p1}, Landroid/support/v4/app/FragmentActivity;->a(Landroid/support/v4/app/h;Landroid/arch/lifecycle/Lifecycle$State;)Z
...
.method private b(Landroid/support/v4/app/Fragment;)I
    ...
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->i:Landroid/support/v4/e/n;
    ...
    iget v2, p0, Landroid/support/v4/app/FragmentActivity;->h:I
    ...
    iget v0, p0, Landroid/support/v4/app/FragmentActivity;->h:I

    add-int/lit8 v0, v0, 0x1

    rem-int/2addr v0, v1

    iput v0, p0, Landroid/support/v4/app/FragmentActivity;->h:I
    ...
    iget-object v2, p0, Landroid/support/v4/app/FragmentActivity;->i:Landroid/support/v4/e/n;
    ...
    iget p1, p0, Landroid/support/v4/app/FragmentActivity;->h:I

    add-int/lit8 p1, p1, 0x1

    rem-int/2addr p1, v1

    iput p1, p0, Landroid/support/v4/app/FragmentActivity;->h:I
...
.method private g()V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/app/FragmentActivity;->a(Landroid/support/v4/app/h;Landroid/arch/lifecycle/Lifecycle$State;)Z
...
.method public a()Landroid/arch/lifecycle/Lifecycle;
    ...
    invoke-super {p0}, Landroid/support/v4/app/SupportActivity;->a()Landroid/arch/lifecycle/Lifecycle;
...
.method public b()Landroid/arch/lifecycle/n;
    ...
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->j:Landroid/arch/lifecycle/n;
    ...
    iget-object v0, v0, Landroid/support/v4/app/FragmentActivity$b;->b:Landroid/arch/lifecycle/n;

    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->j:Landroid/arch/lifecycle/n;
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->i:Landroid/support/v4/e/n;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v2, v0, Landroid/support/v4/app/FragmentActivity$b;->b:Landroid/arch/lifecycle/n;

    if-eqz v2, :cond_0

    iget-object v2, p0, Landroid/support/v4/app/FragmentActivity;->j:Landroid/arch/lifecycle/n;

    if-nez v2, :cond_0

    iget-object v2, v0, Landroid/support/v4/app/FragmentActivity$b;->b:Landroid/arch/lifecycle/n;

    iput-object v2, p0, Landroid/support/v4/app/FragmentActivity;->j:Landroid/arch/lifecycle/n;
    ...
    iput-object v1, p0, Landroid/support/v4/app/FragmentActivity;->i:Landroid/support/v4/e/n;
    ...
    iget-object v3, p0, Landroid/support/v4/app/FragmentActivity;->i:Landroid/support/v4/e/n;
    ...
    :cond_4
    iget-object p1, p0, Landroid/support/v4/app/FragmentActivity;->i:Landroid/support/v4/e/n;
    ...
    iput-object p1, p0, Landroid/support/v4/app/FragmentActivity;->i:Landroid/support/v4/e/n;

    iput v2, p0, Landroid/support/v4/app/FragmentActivity;->h:I
...
.method public final onRetainNonConfigurationInstance()Ljava/lang/Object;
    ...
    iput-object v0, v2, Landroid/support/v4/app/FragmentActivity$b;->b:Landroid/arch/lifecycle/n;
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget v1, p0, Landroid/support/v4/app/FragmentActivity;->h:I
