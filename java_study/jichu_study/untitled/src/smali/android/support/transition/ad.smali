...
.method private static a(Landroid/animation/LayoutTransition;)V
    ...
    sput-object v2, Landroid/support/transition/ad;->d:Ljava/lang/reflect/Method;

    sget-object v2, Landroid/support/transition/ad;->d:Ljava/lang/reflect/Method;
    ...
    :goto_0
    sput-boolean v0, Landroid/support/transition/ad;->e:Z

    :cond_0
    sget-object v0, Landroid/support/transition/ad;->d:Ljava/lang/reflect/Method;
...
.method static a(Landroid/view/ViewGroup;Z)V
    ...
    sget-object v0, Landroid/support/transition/ad;->a:Landroid/animation/LayoutTransition;
    ...
    sput-object v0, Landroid/support/transition/ad;->a:Landroid/animation/LayoutTransition;
    ...
    sget v0, Landroid/support/transition/n$a;->transition_layout_save:I

    invoke-virtual {p0, v0, p1}, Landroid/view/ViewGroup;->setTag(ILjava/lang/Object;)V

    :cond_2
    sget-object p1, Landroid/support/transition/ad;->a:Landroid/animation/LayoutTransition;
    ...
    sget-boolean p1, Landroid/support/transition/ad;->c:Z
    ...
    sput-object p1, Landroid/support/transition/ad;->b:Ljava/lang/reflect/Field;

    sget-object p1, Landroid/support/transition/ad;->b:Ljava/lang/reflect/Field;
    ...
    :goto_1
    sput-boolean v1, Landroid/support/transition/ad;->c:Z
    ...
    :try_start_2
    sget-object v0, Landroid/support/transition/ad;->b:Ljava/lang/reflect/Field;
    ...
    :cond_7
    sget p1, Landroid/support/transition/n$a;->transition_layout_save:I
