...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v1, Landroid/support/transition/r;->g:[I
    ...
    invoke-static {p1, p2, v1, v0, v0}, Landroid/support/v4/content/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Z
    ...
    invoke-static {p1, p2, v1, v2, v0}, Landroid/support/v4/content/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Z
...
.method private a(Landroid/support/transition/w;Landroid/support/transition/w;Z)Landroid/animation/ObjectAnimator;
    ...
    sget-object p1, Landroid/support/transition/j;->a:Landroid/graphics/Matrix;

    :cond_0
    if-nez v0, :cond_1

    sget-object v0, Landroid/support/transition/j;->a:Landroid/graphics/Matrix;
    ...
    invoke-static {v0, p1}, Landroid/support/transition/m;->a(Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/PropertyValuesHolder;
...
.method private a(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    ...
    :cond_0
    invoke-virtual {p0, p1, v1}, Landroid/support/transition/ChangeTransform;->b(Landroid/view/View;Z)Landroid/support/transition/w;
...
.method private b(Landroid/support/transition/w;Landroid/support/transition/w;)V
    .locals 3
...
.method private b(Landroid/view/ViewGroup;Landroid/support/transition/w;Landroid/support/transition/w;)V
    .locals 3
    ...
    invoke-static {v0, p1, v2}, Landroid/support/transition/h;->a(Landroid/view/View;Landroid/view/ViewGroup;Landroid/graphics/Matrix;)Landroid/support/transition/g;
    ...
    invoke-interface {p1, v1, v2}, Landroid/support/transition/g;->a(Landroid/view/ViewGroup;Landroid/view/View;)V
    ...
    invoke-direct {v2, v0, p1}, Landroid/support/transition/ChangeTransform$a;-><init>(Landroid/view/View;Landroid/support/transition/g;)V
...
.method private d(Landroid/support/transition/w;)V
    ...
    sget v3, Landroid/support/transition/n$a;->transition_transform:I
    ...
    sget v2, Landroid/support/transition/n$a;->parent_matrix:I
...
.method public a(Landroid/view/ViewGroup;Landroid/support/transition/w;Landroid/support/transition/w;)Landroid/animation/Animator;
    ...
    invoke-direct {p0, p2, p3}, Landroid/support/transition/ChangeTransform;->b(Landroid/support/transition/w;Landroid/support/transition/w;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroid/support/transition/ChangeTransform;->b(Landroid/view/ViewGroup;Landroid/support/transition/w;Landroid/support/transition/w;)V
...
.method public a(Landroid/support/transition/w;)V
    ...
    invoke-direct {p0, p1}, Landroid/support/transition/ChangeTransform;->d(Landroid/support/transition/w;)V
